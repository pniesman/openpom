...
S1 <- read.csv("/Users/pn254/Documents/osmo-odor-analysis/lee_et_al_2023/data/Data S1.csv") %>%
...
S3 <- read.csv("/Users/pn254/Documents/osmo-odor-analysis/lee_et_al_2023/data/Data S3.csv")

#Odor attribute predictions on 400 molecules by a random forest model trained on GS/LF datasets
S4 <- read.csv("/Users/pn254/Documents/osmo-odor-analysis/lee_et_al_2023/data/Data S4.csv")

#Odor attribute predictions on 400 molecules by a graph neural network model trained on GS/LF datasets. Final layer.
S5 <- read.csv("/Users/pn254/Documents/osmo-odor-analysis/lee_et_al_2023/data/Data S5.csv")

#Graph neural network embeddings on 400 molecules. Penultimate layer.
S6 <- read.csv("/Users/pn254/Documents/osmo-odor-analysis/lee_et_al_2023/data/Data S6.csv")

#Correspondence table between internal odorant identifiers and chemical structures
S7 <- read.csv("/Users/pn254/Documents/osmo-odor-analysis/lee_et_al_2023/data/Data S7.csv")
```
...
gnnP_long <- S5 |>
  pivot_longer(cols = c(2:56), names_to = "Descriptor", values_to = "GNNprediction") |>
  rename(SampleIdentifier = RedJade.Code) 
  #mutate(SampleIdentifier = as.numeric(RedJade.Code))
